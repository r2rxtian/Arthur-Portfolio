...
export const skillCategoriesData: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Node.js / Bun', level: 'Expert', category: 'Runtime', highlight: true },
      { name: 'Go (Golang)', level: 'Advanced', category: 'Language', highlight: true },
      { name: 'Python / FastAPI', level: 'Advanced', category: 'Language' },
      ...
      { name: 'Apache Kafka / RabbitMQ', level: 'Advanced', category: 'Streaming' },
      { name: 'REST & GraphQL APIs', level: 'Expert', category: 'API Design' },
      { name: 'gRPC & Protocol Buffers', level: 'Advanced', category: 'Networking' },
    ],
  },
  {
    id: 'devops',
